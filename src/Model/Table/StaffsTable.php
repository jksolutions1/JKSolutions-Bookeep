...
class StaffsTable extends Table
{
    ...
    {
        $validator
            ->integer('staff_firstname')
            ->requirePresence('staff_firstname', 'create')
            ->notEmptyString('staff_firstname');

        $validator
            ->integer('staff_lastname')
            ->requirePresence('staff_lastname', 'create')
            ->notEmptyString('staff_lastname');

        $validator
            ->integer('staff_contactno')
            ->requirePresence('staff_contactno', 'create')
            ->notEmptyString('staff_contactno');

        $validator
            ->integer('staff_address')
